...
//				
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					m1.rungame();
					a = m1.maxSteps;
//					System.out.println(m1.money_array[0][1]);
//					System.out.println(m1.money_array[1][1]);
...
//			if(monezi[zero][zeko]<=0) {
//				playerPool[zero].setText("BROKE");
//				continue;	
//				}
...
//			System.out.println("Prev y x"+xPreviousPos+" "+yPreviousPos);
//			System.out.println("Current y x"+xCurrentPos+" "+yCurrentPos);
			
			
//			System.out.println("Position is "+t[zero]);
			
			xSubtract = xCurrentPos[zero] - xPreviousPos[zero];
			ySubtract = yCurrentPos[zero] - yPreviousPos[zero];
			
//			System.out.println("Player "+(zero+1) + " has PrevPos "+"("+xPreviousPos[zero]+")"+ " and CurrentPos "+xCurrentPos[zero]);
			
//			System.out.println("y is "+zero + "x is "+one);
...
//			moneyPlayerPool[zero].setText(String.valueOf(monezi[zero][z]));
//			moneyvar=monezi[zero][z];
